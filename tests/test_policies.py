...
Uses synchronous versions of the policy functions for direct unit testing.
"""
...
class TestModelAllowlist:
    ...
    def test_allowed_model_passes(self, db_engine):
        ...
        # Should not raise.
        policies.check_model_allowed_sync("gpt-4o", "Planning", db_engine)
    ...
    def test_disallowed_model_returns_403(self, db_engine):
        ...
        with pytest.raises(HTTPException) as exc_info:
            policies.check_model_allowed_sync("gpt-4o", "Finance", db_engine)
    ...
    def test_no_policy_allows_all(self, db_engine):
        ...
        policies.check_model_allowed_sync("gpt-4o", "Engineering", db_engine)
...
class TestBudgetEnforcement:
    ...
    def test_under_budget_passes(self, db_engine):
        ...
        policies.check_budget_sync("Planning", db_engine)
    ...
    def test_over_budget_returns_429(self, db_engine):
        ...
        with pytest.raises(HTTPException) as exc_info:
            policies.check_budget_sync("Finance", db_engine)
        assert exc_info.value.status_code == 429
